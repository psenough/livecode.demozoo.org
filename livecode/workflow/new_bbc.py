...
TEMPLATE = {
    ...
    "staffs": [
        {
            "handle": {"name": "aldroid", "demozoo_id": 63755},
            "job": "Organizers",
        }
    ],
                ...
                "entries": [
                    {
                        ...
                        "rank": None,
                        "points": None,
                        "handle": {"name": None, "demozoo_id": None},
                        "shadertoy_url": None,
                        "source_file": (
                            paths["base_source_file"] / Path('replace.lua')
                        ).as_posix(),
                        "preview_image": (
                            paths["base_preview_image"] / Path('replace.gif')
                        ).as_posix(),
                    },
                    {
                        "id": 2,
...
def generate_ffmc(date, nb_match_byte_battle, nb_participant_byte_jam):
